#!/usr/bin/env python3
"""Script to write agent_mode_mixin.py"""
...
with open('mixins/agent_mode_mixin.py', 'w', encoding='utf-8') as f:
    f.write(content)

print(f"Written {len(content)} bytes to mixins/agent_mode_mixin.py")

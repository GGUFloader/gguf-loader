> **📦 Archived documentation (v2.1.2-era, restored from git history).**
>
> This folder is preserved for reference. It documents an older app layout
> (e.g. `models/`, `mixins/`, the Smart Floater addon, and the
> `GGUFLoader_WithAddons.exe` build) that no longer matches the current code.
> For the **current** documentation see [README.md](../README.md),
> [QUICK_REFERENCE.md](../QUICK_REFERENCE.md), [AGENTS.md](../AGENTS.md), and
...
| **Phase 2: Addon Ecosystem** | 🔄 Q3–Q4 2025 | 🧪 In Development | - Addon manager + menu launcher (✅ started)<br>- Addon popup architecture<br>- Example addon templates<br>- Addon activation/deactivation<br>- Addon SDK for easy integration |
